module Aws
  module Pipes
    module Model
      ...
      CREATE_PIPE = OperationModel.new(
        name: "CreatePipe",
        http_method: "POST",
        request_uri: "/v1/pipes/{Name}"
      )

      DELETE_PIPE = OperationModel.new(
        name: "DeletePipe",
        http_method: "DELETE",
        request_uri: "/v1/pipes/{Name}"
      )

      DESCRIBE_PIPE = OperationModel.new(
        name: "DescribePipe",
        http_method: "GET",
        request_uri: "/v1/pipes/{Name}"
      )

      LIST_PIPES = OperationModel.new(
        name: "ListPipes",
        http_method: "GET",
        request_uri: "/v1/pipes"
      )
      ...
      START_PIPE = OperationModel.new(
        name: "StartPipe",
        http_method: "POST",
        request_uri: "/v1/pipes/{Name}/start"
      )

      STOP_PIPE = OperationModel.new(
        name: "StopPipe",
        http_method: "POST",
        request_uri: "/v1/pipes/{Name}/stop"
      )
      ...
      UPDATE_PIPE = OperationModel.new(
        name: "UpdatePipe",
        http_method: "PUT",
        request_uri: "/v1/pipes/{Name}"
      )
