  ...
  module BCMPricingCalculator
    module Types
      ...
      struct CreateBillEstimateResponse
        ...
        @[JSON::Field(key: "costCategoryGroupSharingPreferenceEffectiveDate", converter: Aws::Runtime::UnixTimestampConverter)]
      ...
      struct CreateWorkloadEstimateResponse
        ...
        @[JSON::Field(key: "rateTimestamp", converter: Aws::Runtime::UnixTimestampConverter)]
      ...
      struct FilterTimestamp
        ...
        @[JSON::Field(key: "afterTimestamp", converter: Aws::Runtime::UnixTimestampConverter)]
        getter after_timestamp : Time?

        # Include results before this timestamp.

        @[JSON::Field(key: "beforeTimestamp", converter: Aws::Runtime::UnixTimestampConverter)]
      ...
      struct UsageAmount
        ...
        @[JSON::Field(key: "startHour", converter: Aws::Runtime::UnixTimestampConverter)]
