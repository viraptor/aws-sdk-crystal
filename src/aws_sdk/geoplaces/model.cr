module AwsSdk
  module GeoPlaces
    module Model
      ...
      AUTOCOMPLETE = OperationModel.new(
        name: "Autocomplete",
        http_method: "POST",
        request_uri: "/autocomplete"
      )

      GEOCODE = OperationModel.new(
        name: "Geocode",
        http_method: "POST",
        request_uri: "/geocode"
      )
      ...
      GET_PLACE = OperationModel.new(
        name: "GetPlace",
        http_method: "GET",
        request_uri: "/place/{PlaceId}"
      )

      REVERSE_GEOCODE = OperationModel.new(
        name: "ReverseGeocode",
        http_method: "POST",
        request_uri: "/reverse-geocode"
      )

      SEARCH_NEARBY = OperationModel.new(
        name: "SearchNearby",
        http_method: "POST",
        request_uri: "/search-nearby"
      )

      SEARCH_TEXT = OperationModel.new(
        name: "SearchText",
        http_method: "POST",
        request_uri: "/search-text"
      )

      SUGGEST = OperationModel.new(
        name: "Suggest",
        http_method: "POST",
        request_uri: "/suggest"
      )
