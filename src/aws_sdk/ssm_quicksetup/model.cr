module AwsSdk
  module SSMQuickSetup
    module Model
      ...
      CREATE_CONFIGURATION_MANAGER = OperationModel.new(
        name: "CreateConfigurationManager",
        http_method: "POST",
        request_uri: "/configurationManager"
      )

      DELETE_CONFIGURATION_MANAGER = OperationModel.new(
        name: "DeleteConfigurationManager",
        http_method: "DELETE",
        request_uri: "/configurationManager/{ManagerArn}"
      )

      GET_CONFIGURATION = OperationModel.new(
        name: "GetConfiguration",
        http_method: "GET",
        request_uri: "/getConfiguration/{ConfigurationId}"
      )

      GET_CONFIGURATION_MANAGER = OperationModel.new(
      ...
      GET_SERVICE_SETTINGS = OperationModel.new(
        ...
        http_method: "GET",
        request_uri: "/serviceSettings"
      )

      LIST_CONFIGURATION_MANAGERS = OperationModel.new(
        name: "ListConfigurationManagers",
        http_method: "POST",
        request_uri: "/listConfigurationManagers"
      )

      LIST_CONFIGURATIONS = OperationModel.new(
        name: "ListConfigurations",
        http_method: "POST",
        request_uri: "/listConfigurations"
      )

      LIST_QUICK_SETUP_TYPES = OperationModel.new(
        name: "ListQuickSetupTypes",
        http_method: "GET",
        request_uri: "/listQuickSetupTypes"
      )
      ...
      UPDATE_CONFIGURATION_DEFINITION = OperationModel.new(
        name: "UpdateConfigurationDefinition",
        http_method: "PUT",
        request_uri: "/configurationDefinition/{ManagerArn}/{Id}"
      )

      UPDATE_CONFIGURATION_MANAGER = OperationModel.new(
