module AwsSdk
  module GeoMaps
    module Model
      ...
      GET_GLYPHS = OperationModel.new(
        name: "GetGlyphs",
        http_method: "GET",
        request_uri: "/glyphs/{FontStack}/{FontUnicodeRange}"
      )

      GET_SPRITES = OperationModel.new(
        name: "GetSprites",
        http_method: "GET",
        request_uri: "/styles/{Style}/{ColorScheme}/{Variant}/sprites/{FileName}"
      )

      GET_STATIC_MAP = OperationModel.new(
        name: "GetStaticMap",
        http_method: "GET",
        request_uri: "/static/{FileName}"
      )

      GET_STYLE_DESCRIPTOR = OperationModel.new(
        name: "GetStyleDescriptor",
        http_method: "GET",
        request_uri: "/styles/{Style}/descriptor"
      )

      GET_TILE = OperationModel.new(
        name: "GetTile",
        http_method: "GET",
        request_uri: "/tiles/{Tileset}/{Z}/{X}/{Y}"
      )
    end
  end
end
