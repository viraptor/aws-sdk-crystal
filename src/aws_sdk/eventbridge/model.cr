module AwsSdk
  module EventBridge
    module Model
      ...
      UPDATE_EVENT_BUS = OperationModel.new(
        name: "UpdateEventBus",
        http_method: "POST",
        request_uri: "/"
      )
