module AwsSdk
  module TranscribeStreaming
    module Model
      ...
      GET_MEDICAL_SCRIBE_STREAM = OperationModel.new(
        name: "GetMedicalScribeStream",
        http_method: "GET",
        request_uri: "/medical-scribe-stream/{SessionId}"
      )

      START_CALL_ANALYTICS_STREAM_TRANSCRIPTION = OperationModel.new(
        name: "StartCallAnalyticsStreamTranscription",
        http_method: "POST",
        request_uri: "/call-analytics-stream-transcription"
      )

      START_MEDICAL_SCRIBE_STREAM = OperationModel.new(
        name: "StartMedicalScribeStream",
        http_method: "POST",
        request_uri: "/medical-scribe-stream"
      )

      START_MEDICAL_STREAM_TRANSCRIPTION = OperationModel.new(
        name: "StartMedicalStreamTranscription",
        http_method: "POST",
        request_uri: "/medical-stream-transcription"
      )

      START_STREAM_TRANSCRIPTION = OperationModel.new(
