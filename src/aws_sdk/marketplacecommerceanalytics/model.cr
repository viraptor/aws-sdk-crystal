module AwsSdk
  module MarketplaceCommerceAnalytics
    module Model
      ...
      GENERATE_DATA_SET = OperationModel.new(
        name: "GenerateDataSet",
        http_method: "POST",
        request_uri: "/"
      )

      START_SUPPORT_DATA_EXPORT = OperationModel.new(
