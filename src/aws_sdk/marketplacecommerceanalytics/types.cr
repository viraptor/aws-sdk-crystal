  ...
  module MarketplaceCommerceAnalytics
    module Types
      ...
      struct GenerateDataSetRequest
        ...
        @[JSON::Field(key: "dataSetPublicationDate", converter: AwsSdk::Runtime::UnixTimestampConverter)]
      ...
      struct StartSupportDataExportRequest
        ...
        @[JSON::Field(key: "fromDate", converter: AwsSdk::Runtime::UnixTimestampConverter)]
