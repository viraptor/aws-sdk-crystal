  ...
  module WorkMail
    class Client
      ...
      def create_alias(
        ...
        input = Types::CreateAliasRequest.new(alias: alias, entity_id: entity_id, organization_id: organization_id)
        create_alias(input)
      end
      ...
      def create_organization(
        ...
        input = Types::CreateOrganizationRequest.new(alias: alias, client_token: client_token, directory_id: directory_id, domains: domains, enable_interoperability: enable_interoperability, kms_key_arn: kms_key_arn)
      ...
      def delete_alias(
        ...
        input = Types::DeleteAliasRequest.new(alias: alias, entity_id: entity_id, organization_id: organization_id)
        delete_alias(input)
      end
