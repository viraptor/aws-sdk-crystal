module AwsSdk
  module MigrationHubConfig
    module Model
      ...
      CREATE_HOME_REGION_CONTROL = OperationModel.new(
        name: "CreateHomeRegionControl",
        http_method: "POST",
        request_uri: "/"
      )

      DELETE_HOME_REGION_CONTROL = OperationModel.new(
        name: "DeleteHomeRegionControl",
        http_method: "POST",
        request_uri: "/"
      )

      DESCRIBE_HOME_REGION_CONTROLS = OperationModel.new(
        name: "DescribeHomeRegionControls",
        http_method: "POST",
        request_uri: "/"
      )

      GET_HOME_REGION = OperationModel.new(
        name: "GetHomeRegion",
        http_method: "POST",
        request_uri: "/"
      )
