module AwsSdk
  module KinesisVideoSignaling
    module Model
      ...
      GET_ICE_SERVER_CONFIG = OperationModel.new(
        name: "GetIceServerConfig",
        http_method: "POST",
        request_uri: "/v1/get-ice-server-config"
      )

      SEND_ALEXA_OFFER_TO_MASTER = OperationModel.new(
        name: "SendAlexaOfferToMaster",
        http_method: "POST",
        request_uri: "/v1/send-alexa-offer-to-master"
      )
    end
  end
end
