module AwsSdk
  module SSMGuiConnect
    module Model
      ...
      DELETE_CONNECTION_RECORDING_PREFERENCES = OperationModel.new(
        name: "DeleteConnectionRecordingPreferences",
        http_method: "POST",
        request_uri: "/DeleteConnectionRecordingPreferences"
      )

      GET_CONNECTION_RECORDING_PREFERENCES = OperationModel.new(
        name: "GetConnectionRecordingPreferences",
        http_method: "POST",
        request_uri: "/GetConnectionRecordingPreferences"
      )

      UPDATE_CONNECTION_RECORDING_PREFERENCES = OperationModel.new(
        name: "UpdateConnectionRecordingPreferences",
        http_method: "POST",
        request_uri: "/UpdateConnectionRecordingPreferences"
      )
    end
  end
end
