  ...
  module CloudWatchEvents
    module Types
      ...
      struct Connection
        ...
        @[JSON::Field(key: "LastAuthorizedTime", converter: AwsSdk::Runtime::UnixTimestampConverter)]
      ...
      struct CreateEventBusRequest
        ...
        # The name of the new event bus. Event bus names cannot contain the / character. You can't use the
      ...
      struct DescribeReplayResponse
        ...
        @[JSON::Field(key: "EventLastReplayedTime", converter: AwsSdk::Runtime::UnixTimestampConverter)]
        ...
        @[JSON::Field(key: "ReplayEndTime", converter: AwsSdk::Runtime::UnixTimestampConverter)]
        ...
        @[JSON::Field(key: "ReplayStartTime", converter: AwsSdk::Runtime::UnixTimestampConverter)]
      ...
      struct InputTransformer
        ...
        # brackets: &lt; value &gt; The InputTemplate must be valid JSON. If InputTemplate is a JSON object
        # (surrounded by curly braces), the following restrictions apply: The placeholder cannot be used as an
        # object key. The following example shows the syntax for using InputPathsMap and InputTemplate .
        # "InputTransformer": { "InputPathsMap": {"instance": "$.detail.instance","status":
        # "$.detail.status"}, "InputTemplate": "&lt;instance&gt; is in state &lt;status&gt;" } To have the
        # InputTemplate include quote marks within a JSON string, escape each quote marks with a slash, as in
        # the following example: "InputTransformer": { "InputPathsMap": {"instance":
        # "$.detail.instance","status": "$.detail.status"}, "InputTemplate": "&lt;instance&gt; is in state
        # \"&lt;status&gt;\"" } The InputTemplate can also be valid JSON with varibles in quotes or out, as in
        # the following example: "InputTransformer": { "InputPathsMap": {"instance":
