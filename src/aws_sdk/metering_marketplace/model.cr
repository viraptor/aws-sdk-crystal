module AwsSdk
  module MarketplaceMetering
    module Model
      ...
      BATCH_METER_USAGE = OperationModel.new(
        name: "BatchMeterUsage",
        http_method: "POST",
        request_uri: "/"
      )

      METER_USAGE = OperationModel.new(
        name: "MeterUsage",
        http_method: "POST",
        request_uri: "/"
      )

      REGISTER_USAGE = OperationModel.new(
        name: "RegisterUsage",
        http_method: "POST",
        request_uri: "/"
      )

      RESOLVE_CUSTOMER = OperationModel.new(
