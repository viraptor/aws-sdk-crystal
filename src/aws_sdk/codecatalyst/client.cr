  ...
  module CodeCatalyst
    class Client
      ...
      def create_dev_environment(
        ...
        input = Types::CreateDevEnvironmentRequest.new(instance_type: instance_type, persistent_storage: persistent_storage, project_name: project_name, space_name: space_name, alias: alias, client_token: client_token, ides: ides, inactivity_timeout_minutes: inactivity_timeout_minutes, repositories: repositories, vpc_connection_name: vpc_connection_name)
      ...
      def update_dev_environment(
        ...
        input = Types::UpdateDevEnvironmentRequest.new(id: id, project_name: project_name, space_name: space_name, alias: alias, client_token: client_token, ides: ides, inactivity_timeout_minutes: inactivity_timeout_minutes, instance_type: instance_type)
