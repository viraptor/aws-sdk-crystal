  ...
  module Amp
    class Client
      ...
      def create_anomaly_detector(
        ...
        input = Types::CreateAnomalyDetectorRequest.new(alias: alias, configuration: configuration, workspace_id: workspace_id, client_token: client_token, evaluation_interval_in_seconds: evaluation_interval_in_seconds, labels: labels, missing_data_action: missing_data_action, tags: tags)
      ...
      def create_scraper(
        ...
        input = Types::CreateScraperRequest.new(destination: destination, scrape_configuration: scrape_configuration, source: source, alias: alias, client_token: client_token, role_configuration: role_configuration, tags: tags)
      ...
      def create_workspace(
        ...
        input = Types::CreateWorkspaceRequest.new(alias: alias, client_token: client_token, kms_key_arn: kms_key_arn, tags: tags)
      ...
      def list_anomaly_detectors(
        ...
        input = Types::ListAnomalyDetectorsRequest.new(workspace_id: workspace_id, alias: alias, max_results: max_results, next_token: next_token)
      ...
      def list_workspaces(
        ...
        input = Types::ListWorkspacesRequest.new(alias: alias, max_results: max_results, next_token: next_token)
      ...
      def update_scraper(
        ...
        input = Types::UpdateScraperRequest.new(scraper_id: scraper_id, alias: alias, client_token: client_token, destination: destination, role_configuration: role_configuration, scrape_configuration: scrape_configuration)
      ...
      def update_workspace_alias(
        ...
        input = Types::UpdateWorkspaceAliasRequest.new(workspace_id: workspace_id, alias: alias, client_token: client_token)
