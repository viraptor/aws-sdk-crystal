  ...
  module FinspaceData
    class Client
      ...
      def create_dataset(
        ...
        input = Types::CreateDatasetRequest.new(dataset_title: dataset_title, kind: kind, permission_group_params: permission_group_params, alias_: alias_, client_token: client_token, dataset_description: dataset_description, owner_info: owner_info, schema_definition: schema_definition)
      ...
      def update_dataset(
        ...
        input = Types::UpdateDatasetRequest.new(dataset_id: dataset_id, dataset_title: dataset_title, kind: kind, alias_: alias_, client_token: client_token, dataset_description: dataset_description, schema_definition: schema_definition)
