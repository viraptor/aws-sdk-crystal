module AwsSdk
  module CodeGuruSecurity
    module Model
      ...
      BATCH_GET_FINDINGS = OperationModel.new(
        name: "BatchGetFindings",
        http_method: "POST",
        request_uri: "/batchGetFindings"
      )

      CREATE_SCAN = OperationModel.new(
        name: "CreateScan",
        http_method: "POST",
        request_uri: "/scans"
      )
      ...
      CREATE_UPLOAD_URL = OperationModel.new(
        ...
        http_method: "POST",
        request_uri: "/uploadUrl"
      )

      GET_ACCOUNT_CONFIGURATION = OperationModel.new(
        name: "GetAccountConfiguration",
        http_method: "GET",
        request_uri: "/accountConfiguration/get"
      )

      GET_FINDINGS = OperationModel.new(
        name: "GetFindings",
        http_method: "GET",
        request_uri: "/findings/{scanName}"
      )

      GET_METRICS_SUMMARY = OperationModel.new(
        name: "GetMetricsSummary",
        http_method: "GET",
        request_uri: "/metrics/summary"
      )

      GET_SCAN = OperationModel.new(
        name: "GetScan",
        http_method: "GET",
        request_uri: "/scans/{scanName}"
      )

      LIST_FINDINGS_METRICS = OperationModel.new(
        name: "ListFindingsMetrics",
        http_method: "GET",
        request_uri: "/metrics/findings"
      )

      LIST_SCANS = OperationModel.new(
        name: "ListScans",
        http_method: "GET",
        request_uri: "/scans"
      )
      ...
      UPDATE_ACCOUNT_CONFIGURATION = OperationModel.new(
        ...
        http_method: "PUT",
        request_uri: "/updateAccountConfiguration"
      )
    end
  end
end
