module AwsSdk
  module Firehose
    module Model
      ...
      CREATE_DELIVERY_STREAM = OperationModel.new(
        name: "CreateDeliveryStream",
        http_method: "POST",
        request_uri: "/"
      )

      DELETE_DELIVERY_STREAM = OperationModel.new(
        name: "DeleteDeliveryStream",
        http_method: "POST",
        request_uri: "/"
      )

      DESCRIBE_DELIVERY_STREAM = OperationModel.new(
        name: "DescribeDeliveryStream",
        http_method: "POST",
        request_uri: "/"
      )

      LIST_DELIVERY_STREAMS = OperationModel.new(
        name: "ListDeliveryStreams",
        http_method: "POST",
        request_uri: "/"
      )

      LIST_TAGS_FOR_DELIVERY_STREAM = OperationModel.new(
      ...
      PUT_RECORD_BATCH = OperationModel.new(
        name: "PutRecordBatch",
        http_method: "POST",
        request_uri: "/"
      )

      START_DELIVERY_STREAM_ENCRYPTION = OperationModel.new(
        name: "StartDeliveryStreamEncryption",
        http_method: "POST",
        request_uri: "/"
      )

      STOP_DELIVERY_STREAM_ENCRYPTION = OperationModel.new(
        name: "StopDeliveryStreamEncryption",
        http_method: "POST",
        request_uri: "/"
      )

      TAG_DELIVERY_STREAM = OperationModel.new(
        name: "TagDeliveryStream",
        http_method: "POST",
        request_uri: "/"
      )

      UNTAG_DELIVERY_STREAM = OperationModel.new(
