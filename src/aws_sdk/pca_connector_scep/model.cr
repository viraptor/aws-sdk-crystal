module AwsSdk
  module PcaConnectorScep
    module Model
      ...
      CREATE_CHALLENGE = OperationModel.new(
        name: "CreateChallenge",
        http_method: "POST",
        request_uri: "/challenges"
      )
      ...
      DELETE_CHALLENGE = OperationModel.new(
        name: "DeleteChallenge",
        http_method: "DELETE",
        request_uri: "/challenges/{ChallengeArn}"
      )
      ...
      GET_CHALLENGE_METADATA = OperationModel.new(
        name: "GetChallengeMetadata",
        http_method: "GET",
        request_uri: "/challengeMetadata/{ChallengeArn}"
      )

      GET_CHALLENGE_PASSWORD = OperationModel.new(
        name: "GetChallengePassword",
        http_method: "GET",
        request_uri: "/challengePasswords/{ChallengeArn}"
      )
      ...
      LIST_CHALLENGE_METADATA = OperationModel.new(
        name: "ListChallengeMetadata",
        http_method: "GET",
        request_uri: "/challengeMetadata"
      )
