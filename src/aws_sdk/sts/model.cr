module AwsSdk
  module STS
    module Model
      ...
      ASSUME_ROLE = OperationModel.new(
        name: "AssumeRole",
        http_method: "POST",
        request_uri: "/"
      )

      ASSUME_ROLE_WITH_SAML = OperationModel.new(
        name: "AssumeRoleWithSAML",
        http_method: "POST",
        request_uri: "/"
      )

      ASSUME_ROLE_WITH_WEB_IDENTITY = OperationModel.new(
        name: "AssumeRoleWithWebIdentity",
        http_method: "POST",
        request_uri: "/"
      )

      ASSUME_ROOT = OperationModel.new(
        name: "AssumeRoot",
        http_method: "POST",
        request_uri: "/"
      )

      DECODE_AUTHORIZATION_MESSAGE = OperationModel.new(
        name: "DecodeAuthorizationMessage",
        http_method: "POST",
        request_uri: "/"
      )

      GET_ACCESS_KEY_INFO = OperationModel.new(
        name: "GetAccessKeyInfo",
        http_method: "POST",
        request_uri: "/"
      )

      GET_CALLER_IDENTITY = OperationModel.new(
        name: "GetCallerIdentity",
        http_method: "POST",
        request_uri: "/"
      )

      GET_DELEGATED_ACCESS_TOKEN = OperationModel.new(
      ...
      GET_SESSION_TOKEN = OperationModel.new(
        name: "GetSessionToken",
        http_method: "POST",
        request_uri: "/"
      )

      GET_WEB_IDENTITY_TOKEN = OperationModel.new(
