  ...
  module VoiceID
    module Types
      ...
      struct AuthenticationResult
        ...
        @[JSON::Field(key: "AudioAggregationEndedAt", converter: AwsSdk::Runtime::UnixTimestampConverter)]
        getter audio_aggregation_ended_at : Time?

        # A timestamp of when audio aggregation started for this authentication result.
        @[JSON::Field(key: "AudioAggregationStartedAt", converter: AwsSdk::Runtime::UnixTimestampConverter)]
      ...
      struct Speaker
        ...
        @[JSON::Field(key: "LastAccessedAt", converter: AwsSdk::Runtime::UnixTimestampConverter)]
