  ...
  module ControlCatalog
    module Model
      ...
      GET_CONTROL = OperationModel.new(
        name: "GetControl",
        http_method: "POST",
        request_uri: "/get-control"
      )

      LIST_COMMON_CONTROLS = OperationModel.new(
        name: "ListCommonControls",
        http_method: "POST",
        request_uri: "/common-controls"
      )

      LIST_CONTROL_MAPPINGS = OperationModel.new(
        name: "ListControlMappings",
        http_method: "POST",
        request_uri: "/list-control-mappings"
      )

      LIST_CONTROLS = OperationModel.new(
        name: "ListControls",
        http_method: "POST",
        request_uri: "/list-controls"
      )
      ...
      LIST_OBJECTIVES = OperationModel.new(
        name: "ListObjectives",
        http_method: "POST",
        request_uri: "/objectives"
      )
    end
  end
end
