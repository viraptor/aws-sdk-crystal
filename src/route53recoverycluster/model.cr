module Aws
  module Route53RecoveryCluster
    module Model
      ...
      GET_ROUTING_CONTROL_STATE = OperationModel.new(
      ...
      UPDATE_ROUTING_CONTROL_STATE = OperationModel.new(
        name: "UpdateRoutingControlState",
        http_method: "POST",
        request_uri: "/"
      )

      UPDATE_ROUTING_CONTROL_STATES = OperationModel.new(
