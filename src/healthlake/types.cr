  ...
  module HealthLake
    module Types
      ...
      struct DatastoreFilter
        ...
        @[JSON::Field(key: "CreatedAfter", converter: Aws::Runtime::UnixTimestampConverter)]
        getter created_after : Time?

        # Filter to set cutoff dates for records. All data stores created before the specified date are
        # included in the results.

        @[JSON::Field(key: "CreatedBefore", converter: Aws::Runtime::UnixTimestampConverter)]
      ...
      struct ListFHIRExportJobsRequest
        ...
        @[JSON::Field(key: "SubmittedAfter", converter: Aws::Runtime::UnixTimestampConverter)]
        getter submitted_after : Time?

        # Limits the response to FHIR export jobs submitted before a user- specified date.

        @[JSON::Field(key: "SubmittedBefore", converter: Aws::Runtime::UnixTimestampConverter)]
