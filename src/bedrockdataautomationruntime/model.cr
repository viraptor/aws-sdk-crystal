module Aws
  module BedrockDataAutomationRuntime
    module Model
      ...
      GET_DATA_AUTOMATION_STATUS = OperationModel.new(
        name: "GetDataAutomationStatus",
        http_method: "POST",
        request_uri: "/"
      )

      INVOKE_DATA_AUTOMATION = OperationModel.new(
        name: "InvokeDataAutomation",
        http_method: "POST",
        request_uri: "/"
      )

      INVOKE_DATA_AUTOMATION_ASYNC = OperationModel.new(
