module Aws
  module MarketplaceReporting
    module Model
      ...
      GET_BUYER_DASHBOARD = OperationModel.new(
        name: "GetBuyerDashboard",
        http_method: "POST",
        request_uri: "/getBuyerDashboard"
      )
    end
  end
end
