  ...
  module MedicalImaging
    module Types
      ...
      struct DICOMUpdates
        ...
        @[JSON::Field(key: "removableAttributes", converter: Aws::Runtime::Base64BytesConverter)]
        getter removable_attributes : Bytes?

        # The DICOM tags that need to be updated in ImageSetMetadata .
        @[JSON::Field(key: "updatableAttributes", converter: Aws::Runtime::Base64BytesConverter)]
      ...
      struct GetImageFrameResponse
        ...
        @[JSON::Field(key: "imageFrameBlob", converter: Aws::Runtime::Base64BytesConverter)]
      ...
      struct GetImageSetMetadataResponse
        ...
        @[JSON::Field(key: "imageSetMetadataBlob", converter: Aws::Runtime::Base64BytesConverter)]
