module Aws
  module CloudTrailData
    module Model
      ...
      PUT_AUDIT_EVENTS = OperationModel.new(
        name: "PutAuditEvents",
        http_method: "POST",
