module Aws
  module KinesisVideoArchivedMedia
    module Model
      ...
      GET_CLIP = OperationModel.new(
        name: "GetClip",
        http_method: "POST",
        request_uri: "/getClip"
      )

      GET_DASH_STREAMING_SESSION_URL = OperationModel.new(
        name: "GetDASHStreamingSessionURL",
        http_method: "POST",
        request_uri: "/getDASHStreamingSessionURL"
      )

      GET_HLS_STREAMING_SESSION_URL = OperationModel.new(
        name: "GetHLSStreamingSessionURL",
        http_method: "POST",
        request_uri: "/getHLSStreamingSessionURL"
      )

      GET_IMAGES = OperationModel.new(
        name: "GetImages",
        http_method: "POST",
        request_uri: "/getImages"
      )

      GET_MEDIA_FOR_FRAGMENT_LIST = OperationModel.new(
        name: "GetMediaForFragmentList",
        http_method: "POST",
        request_uri: "/getMediaForFragmentList"
      )

      LIST_FRAGMENTS = OperationModel.new(
        name: "ListFragments",
        http_method: "POST",
        request_uri: "/listFragments"
      )
    end
  end
end
