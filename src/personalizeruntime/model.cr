module Aws
  module PersonalizeRuntime
    module Model
      ...
      GET_ACTION_RECOMMENDATIONS = OperationModel.new(
        name: "GetActionRecommendations",
        http_method: "POST",
        request_uri: "/action-recommendations"
      )

      GET_PERSONALIZED_RANKING = OperationModel.new(
        name: "GetPersonalizedRanking",
        http_method: "POST",
        request_uri: "/personalize-ranking"
      )
