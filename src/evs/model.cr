module Aws
  module Evs
    module Model
      ...
      ASSOCIATE_EIP_TO_VLAN = OperationModel.new(
      ...
      CREATE_ENVIRONMENT_HOST = OperationModel.new(
      ...
      DELETE_ENVIRONMENT_HOST = OperationModel.new(
        name: "DeleteEnvironmentHost",
        http_method: "POST",
        request_uri: "/"
      )

      DISASSOCIATE_EIP_FROM_VLAN = OperationModel.new(
      ...
      GET_VERSIONS = OperationModel.new(
        name: "GetVersions",
        http_method: "POST",
        request_uri: "/"
      )

      LIST_ENVIRONMENT_HOSTS = OperationModel.new(
        name: "ListEnvironmentHosts",
        http_method: "POST",
        request_uri: "/"
      )

      LIST_ENVIRONMENT_VLANS = OperationModel.new(
