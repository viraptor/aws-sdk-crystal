module Aws
  module SageMakerFeatureStoreRuntime
    module Model
      ...
      BATCH_GET_RECORD = OperationModel.new(
        name: "BatchGetRecord",
        http_method: "POST",
        request_uri: "/BatchGetRecord"
      )

      DELETE_RECORD = OperationModel.new(
        name: "DeleteRecord",
        http_method: "DELETE",
        request_uri: "/FeatureGroup/{FeatureGroupName}"
      )

      GET_RECORD = OperationModel.new(
        name: "GetRecord",
        http_method: "GET",
        request_uri: "/FeatureGroup/{FeatureGroupName}"
      )
