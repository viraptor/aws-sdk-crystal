module Aws
  module EKSAuth
    module Model
      ...
      ASSUME_ROLE_FOR_POD_IDENTITY = OperationModel.new(
        name: "AssumeRoleForPodIdentity",
        http_method: "POST",
        request_uri: "/clusters/{clusterName}/assume-role-for-pod-identity"
      )
    end
  end
end
