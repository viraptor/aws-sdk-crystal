  ...
  module RDSData
    module Model
      ...
      BATCH_EXECUTE_STATEMENT = OperationModel.new(
        ...
        http_method: "POST",
        request_uri: "/BatchExecute"
      )

      BEGIN_TRANSACTION = OperationModel.new(
        name: "BeginTransaction",
        http_method: "POST",
        request_uri: "/BeginTransaction"
      )
      ...
      EXECUTE_SQL = OperationModel.new(
        name: "ExecuteSql",
        http_method: "POST",
        request_uri: "/ExecuteSql"
      )
      ...
      ROLLBACK_TRANSACTION = OperationModel.new(
        name: "RollbackTransaction",
        http_method: "POST",
        request_uri: "/RollbackTransaction"
      )
    end
  end
end
