module Aws
  module Signin
    module Model
      ...
      CREATE_O_AUTH2_TOKEN = OperationModel.new(
        name: "CreateOAuth2Token",
        http_method: "POST",
        request_uri: "/v1/token"
      )
    end
  end
end
