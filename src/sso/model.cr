module Aws
  module SSO
    module Model
      ...
      GET_ROLE_CREDENTIALS = OperationModel.new(
        name: "GetRoleCredentials",
        http_method: "GET",
        request_uri: "/federation/credentials"
      )

      LIST_ACCOUNT_ROLES = OperationModel.new(
        name: "ListAccountRoles",
        http_method: "GET",
        request_uri: "/assignment/roles"
      )

      LIST_ACCOUNTS = OperationModel.new(
        name: "ListAccounts",
        http_method: "GET",
        request_uri: "/assignment/accounts"
      )

      LOGOUT = OperationModel.new(
        name: "Logout",
        http_method: "POST",
        request_uri: "/logout"
      )
