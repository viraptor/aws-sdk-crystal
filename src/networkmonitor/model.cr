module Aws
  module NetworkMonitor
    module Model
      ...
      CREATE_PROBE = OperationModel.new(
        name: "CreateProbe",
        http_method: "POST",
        request_uri: "/monitors/{monitorName}/probes"
      )
      ...
      DELETE_PROBE = OperationModel.new(
        name: "DeleteProbe",
        http_method: "DELETE",
        request_uri: "/monitors/{monitorName}/probes/{probeId}"
      )
      ...
      UPDATE_PROBE = OperationModel.new(
        name: "UpdateProbe",
        http_method: "PATCH",
        request_uri: "/monitors/{monitorName}/probes/{probeId}"
      )
