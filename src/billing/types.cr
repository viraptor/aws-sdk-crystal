  ...
  module Billing
    module Types
      ...
      struct ActiveTimeRange
        ...
        @[JSON::Field(key: "activeAfterInclusive", converter: Aws::Runtime::UnixTimestampConverter)]
        getter active_after_inclusive : Time

        # The inclusive time range end date.

        @[JSON::Field(key: "activeBeforeInclusive", converter: Aws::Runtime::UnixTimestampConverter)]
      ...
      struct BillingViewElement
        ...
        @[JSON::Field(key: "viewDefinitionLastUpdatedAt", converter: Aws::Runtime::UnixTimestampConverter)]
      ...
      struct TimeRange
        ...
        @[JSON::Field(key: "beginDateInclusive", converter: Aws::Runtime::UnixTimestampConverter)]
        getter begin_date_inclusive : Time?

        # The inclusive end date of the time range.

        @[JSON::Field(key: "endDateInclusive", converter: Aws::Runtime::UnixTimestampConverter)]
