  ...
  module CloudFrontKeyValueStore
    module Model
      ...
      DELETE_KEY = OperationModel.new(
        name: "DeleteKey",
        http_method: "DELETE",
        request_uri: "/key-value-stores/{KvsARN}/keys/{Key}"
      )

      DESCRIBE_KEY_VALUE_STORE = OperationModel.new(
        name: "DescribeKeyValueStore",
        http_method: "GET",
        request_uri: "/key-value-stores/{KvsARN}"
      )
      ...
      LIST_KEYS = OperationModel.new(
        name: "ListKeys",
        http_method: "GET",
        request_uri: "/key-value-stores/{KvsARN}/keys"
      )

      PUT_KEY = OperationModel.new(
        name: "PutKey",
        http_method: "PUT",
        request_uri: "/key-value-stores/{KvsARN}/keys/{Key}"
      )

      UPDATE_KEYS = OperationModel.new(
        name: "UpdateKeys",
        http_method: "POST",
        request_uri: "/key-value-stores/{KvsARN}/keys"
      )
