module Aws
  module GeoRoutes
    module Model
      ...
      CALCULATE_ISOLINES = OperationModel.new(
        name: "CalculateIsolines",
        http_method: "POST",
        request_uri: "/isolines"
      )

      CALCULATE_ROUTE_MATRIX = OperationModel.new(
        name: "CalculateRouteMatrix",
        http_method: "POST",
        request_uri: "/route-matrix"
      )

      CALCULATE_ROUTES = OperationModel.new(
        name: "CalculateRoutes",
        http_method: "POST",
        request_uri: "/routes"
      )

      OPTIMIZE_WAYPOINTS = OperationModel.new(
        name: "OptimizeWaypoints",
        http_method: "POST",
        request_uri: "/optimize-waypoints"
      )

      SNAP_TO_ROADS = OperationModel.new(
        name: "SnapToRoads",
        http_method: "POST",
        request_uri: "/snap-to-roads"
      )
    end
  end
end
