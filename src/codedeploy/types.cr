  ...
  module CodeDeploy
    module Types
      ...
      struct GenericRevisionInfo
        ...
        @[JSON::Field(key: "firstUsedTime", converter: Aws::Runtime::UnixTimestampConverter)]
        getter first_used_time : Time?

        # When the revision was last used by CodeDeploy.

        @[JSON::Field(key: "lastUsedTime", converter: Aws::Runtime::UnixTimestampConverter)]
        getter last_used_time : Time?

        # When the revision was registered with CodeDeploy.

        @[JSON::Field(key: "registerTime", converter: Aws::Runtime::UnixTimestampConverter)]
      ...
      struct InstanceInfo
        ...
        @[JSON::Field(key: "deregisterTime", converter: Aws::Runtime::UnixTimestampConverter)]
