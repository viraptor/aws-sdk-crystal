module Aws
  module SageMakerRuntime
    module Model
      ...
      INVOKE_ENDPOINT = OperationModel.new(
        name: "InvokeEndpoint",
        http_method: "POST",
        request_uri: "/endpoints/{EndpointName}/invocations"
      )

      INVOKE_ENDPOINT_ASYNC = OperationModel.new(
        name: "InvokeEndpointAsync",
        http_method: "POST",
        request_uri: "/endpoints/{EndpointName}/async-invocations"
      )

      INVOKE_ENDPOINT_WITH_RESPONSE_STREAM = OperationModel.new(
        name: "InvokeEndpointWithResponseStream",
        http_method: "POST",
        request_uri: "/endpoints/{EndpointName}/invocations-response-stream"
      )
    end
  end
end
