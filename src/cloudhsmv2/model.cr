module Aws
  module CloudHSMV2
    module Model
      ...
      COPY_BACKUP_TO_REGION = OperationModel.new(
      ...
      INITIALIZE_CLUSTER = OperationModel.new(
      ...
      MODIFY_BACKUP_ATTRIBUTES = OperationModel.new(
      ...
      RESTORE_BACKUP = OperationModel.new(
        name: "RestoreBackup",
        http_method: "POST",
        request_uri: "/"
      )
