module Aws
  module AutoScalingPlans
    module Model
      ...
      CREATE_SCALING_PLAN = OperationModel.new(
        name: "CreateScalingPlan",
        http_method: "POST",
        request_uri: "/"
      )

      DELETE_SCALING_PLAN = OperationModel.new(
        name: "DeleteScalingPlan",
        http_method: "POST",
        request_uri: "/"
      )

      DESCRIBE_SCALING_PLAN_RESOURCES = OperationModel.new(
        name: "DescribeScalingPlanResources",
        http_method: "POST",
        request_uri: "/"
      )

      DESCRIBE_SCALING_PLANS = OperationModel.new(
        name: "DescribeScalingPlans",
        http_method: "POST",
        request_uri: "/"
      )

      GET_SCALING_PLAN_RESOURCE_FORECAST_DATA = OperationModel.new(
        name: "GetScalingPlanResourceForecastData",
        http_method: "POST",
        request_uri: "/"
      )

      UPDATE_SCALING_PLAN = OperationModel.new(
